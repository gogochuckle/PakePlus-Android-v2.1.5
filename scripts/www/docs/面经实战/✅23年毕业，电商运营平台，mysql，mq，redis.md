...
[✅SQL语句如何实现insertOrUpdate的功能？](docs/MySQL/✅SQL语句如何实现insertOrUpdate的功能？.md)
...
[✅rabbitMQ的整体架构是怎么样的？](docs/RabbitMQ/✅rabbitMQ的整体架构是怎么样的？.md)



[✅RabbitMQ是怎么做消息分发的？](docs/RabbitMQ/✅RabbitMQ是怎么做消息分发的？.md)



[✅什么是RabbitMQ的死信队列？](docs/RabbitMQ/✅什么是RabbitMQ的死信队列？.md)
...
[✅线程有几种状态，状态之间的流转是怎样的？](docs/Java并发/✅线程有几种状态，状态之间的流转是怎样的？.md)
...
[✅CompletableFuture的底层是如何实现的？](docs/Java并发/✅CompletableFuture的底层是如何实现的？.md)
...
[✅为什么不能用浮点数表示金额？](docs/Java基础/✅为什么不能用浮点数表示金额？.md)



[✅为什么不能用BigDecimal的equals方法做等值比较？](docs/Java基础/✅为什么不能用BigDecimal的equals方法做等值比较？.md)



[✅Java中有了基本类型为什么还需要包装类？](docs/Java基础/✅Java中有了基本类型为什么还需要包装类？.md)
...
[✅什么是缓存击穿、缓存穿透、缓存雪崩？](docs/Redis/✅什么是缓存击穿、缓存穿透、缓存雪崩？.md)
...
[✅如何用Zookeeper实现分布式锁？](docs/Zookeeper/✅如何用Zookeeper实现分布式锁？.md)
