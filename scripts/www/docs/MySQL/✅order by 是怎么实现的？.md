...
![](images/084c10bd433949ecb8d8f8a887fcfc7f.png)
...
比如这个SQL，那么只需要把d和id放到sort_buffer中，先按照d进行排序。排好之后，就再根据id，把对应的a,d,f几个字段都查询出来，返回给客户端即可。大致过程如下：
...
![](images/2e91ea207fce468793f4e5e28803a92a.png)
