...
[你的项目有哪些难点&亮点？](docs/项目难点&亮点/你的项目有哪些难点&亮点？.md)
...
[✅BigDecimal和Long表示金额哪个更合适，怎么选择？](docs/Java基础/✅BigDecimal和Long表示金额哪个更合适，怎么选择？.md)
...
[✅Leaf生成分布式ID的原理？](docs/分布式/✅Leaf生成分布式ID的原理？.md)
...
[✅Oracle 和 MySQL 的区别是什么？如何选择？](docs/Oracle/✅Oracle 和 MySQL 的区别是什么？如何选择？.md)
...
[✅where条件的顺序影响使用索引吗？](docs/MySQL/✅where条件的顺序影响使用索引吗？.md)



[✅A,B,C的联合索引，按照 AB,AC,BC查询，能走索引吗？](docs/MySQL/✅A,B,C的联合索引，按照 AB,AC,BC查询，能走索引吗？.md)
...
[✅hash冲突通常怎么解决？](docs/集合类/✅hash冲突通常怎么解决？.md)



[✅Java 8中的Stream用过吗？都能干什么？](docs/集合类/✅Java 8中的Stream用过吗？都能干什么？.md)
