...
![](images/1a674e5b238646f28be7d90465b8caba.png)
...
![](images/72155986917f4105b57f9946b673ef3a.png)

**当持有锁的线程释放锁时，AQS会将等待队列中的第一个线程唤醒，并让其重新尝试获取锁。**

![](images/825070617fdb44bb8652c7760979eced.png)
...
![](images/ffdcffe901c34ec09ed640cddc40c64c.png)
...
![](images/6f3924f33da74b50965bd55ee5a86b90.png)
...
![](images/388d93ae736743409ae12625f3a3be19.png)
...
[✅AQS的同步队列和条件队列原理？](docs/Java并发/✅AQS的同步队列和条件队列原理？.md)
...
[✅什么是AQS的独占模式和共享模式？](docs/Java并发/✅什么是AQS的独占模式和共享模式？.md)
