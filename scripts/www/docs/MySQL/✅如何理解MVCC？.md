...
# 扩展知识
### 快照读和当前读
[✅当前读和快照读有什么区别？](docs/MySQL/✅当前读和快照读有什么区别？.md)
...
![](images/287bd0d55e464b498bdf72db730e9438.png)
...
![](images/2dce05ad61d04635833349e2d91d870c.png)
...
<font style="color:rgb(15, 17, 21);">MVCC 的行为在不同隔离级别下是不同的，主要体现在</font><font style="color:rgb(15, 17, 21);"> </font>`<font style="color:rgb(15, 17, 21);">Read View</font>`<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">生成的时机。</font>
...
[✅MySQL如何实现不同隔离级别？](docs/MySQL/✅MySQL如何实现不同隔离级别？.md)
