...
![](images/88a6045baf66400d8d411f7ac9c07fef.png)
...
![](images/42b49c5331754294bca7ba0276161afd.png)

此时thread-2开始执行，当thread-2扩容完成后，结果如下：

![](images/c084e62d236f44519285bd664dba8cb1.png)

此时thread-1抢占到执行时间，开始执行：`e.next = newTable[i]; newTable[i] = e; e = next;`后，会变成如下样式：

![](images/5a93db13e9a44cf5b345e9a341a90eb6.png)

接着，进行下一次循环，继续执行`e.next = newTable[i]; newTable[i] = e; e = next;`，如下图所示

![](images/0116e590eae748cb89ac62b5cd373f8a.png)

因为此时e!=null，且e.next = null，开始执行最后一次循环，结果如下：

![](images/cc1d928c45eb4f518224573f3a55210b.png)
