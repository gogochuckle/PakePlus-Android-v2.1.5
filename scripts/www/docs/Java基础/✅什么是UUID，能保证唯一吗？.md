...
![](images/cf23b3e2681d4ec2b618a9d860833f8d.png)
...
<font style="color:rgb(15, 17, 21);">一个 UUIDv7 是一个 128 位的数字（32 个十六进制字符，以 </font>`<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">xxxxxxxx-xxxx-Mxxx-Nxxx-xxxxxxxxxxxx</font>`<font style="color:rgb(15, 17, 21);"> 的形式显示）。它的结构经过精确定义，以嵌入一个时间戳。</font>
