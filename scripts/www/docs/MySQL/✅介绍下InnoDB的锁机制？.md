...
[✅什么是排他锁和共享锁？](docs/MySQL/✅什么是排他锁和共享锁？.md)
...
![](images/1d78ba8e2fe64f6d9474420738574752.png)
...
[✅高并发情况下自增主键会不会重复，为什么？](docs/MySQL/✅高并发情况下自增主键会不会重复，为什么？.md)
...
[✅InnoDB中的表级锁、页级锁、行级锁？](docs/MySQL/✅InnoDB中的表级锁、页级锁、行级锁？.md)
