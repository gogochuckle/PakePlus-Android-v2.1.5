...
![](images/fd11943736a94ef1a68b3a34752ea8fa.png)
...
[✅Ribbon是怎么做负载均衡的？](docs/SpringCloud/✅Ribbon是怎么做负载均衡的？.md)
...
[✅Hystrix和Sentinel的区别是什么？](docs/SpringCloud/✅Hystrix和Sentinel的区别是什么？.md)



5. ~~Zuul：API网关，可以帮助应用程序处理API请求的路由、负载均衡、安全和监控等问题。~~

[✅Zuul、Gateway和Nginx有什么区别？](docs/SpringCloud/✅Zuul、Gateway和Nginx有什么区别？.md)
...
![](images/93a118e215a744808d9c17f9b9aac6bf.png)
...
![](images/d6c1f03ca50e44129ccfaa4cc3874483.png)
